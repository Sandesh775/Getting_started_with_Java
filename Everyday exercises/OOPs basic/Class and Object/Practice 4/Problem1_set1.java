...
public class Problem1_set1{
    public static void main(String[] args) {
        ...
        Student2 s1 = new Student2("John", 101, marks);
        System.out.println("Displaying the info of original student !");
        s1.displayInfo();
        Student2 s2 = new Student2(s1);
        System.out.println("Displaying the info of John clone !");
        s2.displayInfo();
    }
}
class Student2{
    ...
    public void setMarks(int index, double mark){
        if(mark >= 0 && mark <= 100){
            ...
            System.out.println("Invalid marks : validation (0-100) !!");
            return;
        }
    }
